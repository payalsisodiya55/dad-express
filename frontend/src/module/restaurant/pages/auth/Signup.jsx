      ...
      <div className="w-full lg:w-1/2 h-full flex flex-col">
        ...
        >
          ...
          >
            ...
            {/* Referral code input */}
            <div className="space-y-1.5">
              <Label htmlFor="referralCode" className="text-sm font-medium text-gray-700 flex justify-between">
                Referral Code
                <span className="text-[10px] text-gray-400 font-normal uppercase tracking-widest bg-gray-50 px-1.5 rounded">Optional</span>
              </Label>
              <div className="relative">
                <span className="absolute inset-y-0 left-3 flex items-center text-gray-400 pointer-events-none">
              ...
              {formData.referralCode && (
                <div className="flex items-center gap-2 p-3 bg-green-50 border border-green-100 rounded-lg animate-in fade-in slide-in-from-top-2 duration-300">
                  <div className="w-5 h-5 bg-green-500 rounded-full flex items-center justify-center shrink-0">
                    <CheckCircle2 className="h-3 w-3 text-white" />
                  </div>
                  <p className="text-[11px] text-green-700 font-bold leading-tight">
                    Referral applied! Referrer restaurant will get commission benefit.
                  </p>
                </div>
              )}
            </div>
