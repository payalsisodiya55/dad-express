    ...
    items: [
      ...
      },
      {
        ...
        subItems: [
          ...
          {
            label: "Referral Mapping",
            path: "/admin/restaurants/referral-mapping",
          },
          {
    ...
    items: [
      {
        ...
        icon: "Gift",
        subItems: [
          { label: "Settings", path: "/admin/referral/settings" },
          { label: "Analytics", path: "/admin/referral/analytics" },
          { label: "Referral Log", path: "/admin/referral/users" },
          { label: "Manual Adjustment", path: "/admin/referral/adjustment" },
        ],
      },
    ],
  },
